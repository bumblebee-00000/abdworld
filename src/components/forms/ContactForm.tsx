...
export default function ContactForm() {
  ...
  if (status === 'success') {
    return (
      <motion.div
        ...
        className="bg-white rounded-2xl border border-cream-200 shadow-xl shadow-emerald-900/5 p-8 text-center"
      >
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="bg-white rounded-2xl border border-cream-200 shadow-xl shadow-emerald-900/5 p-6 md:p-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <div className="relative">
            <FileText className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-emerald-900/40" />
            <input
              type="text"
              name="subject"
      ...
      <button
        ...
        className="mt-6 w-full inline-flex items-center justify-center gap-2 px-6 py-4 bg-emerald-800 text-white font-bold rounded-xl hover:bg-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-300 shadow-lg shadow-emerald-900/10"
      >
        {isSubmitting ? (
          <>
